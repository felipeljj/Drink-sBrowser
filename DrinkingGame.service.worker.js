...
/** @type {string} */
const CACHE_VERSION = '1764962531|12805715524';
/** @type {string} */
const CACHE_PREFIX = 'DrinkingGame-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'DrinkingGame.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["DrinkingGame.html","DrinkingGame.js","DrinkingGame.offline.html","DrinkingGame.icon.png","DrinkingGame.apple-touch-icon.png","DrinkingGame.audio.worklet.js","DrinkingGame.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["DrinkingGame.wasm","DrinkingGame.pck","DrinkingGame.side.wasm"];
